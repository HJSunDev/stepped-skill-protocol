...
Review the SSP architecture draft for product essence, protocol boundaries, and overclaiming.

## Expected Output

Findings ordered by severity, with architecture-level recommendations.
...
- Save the final user-facing output to `outputs/B021.md`.
- Save any execution notes, including observed reads and failures, to `traces/MR-01-O.md`.
