...
Produce a release-readiness brief for turning SSP from architecture draft into public spec.

## Expected Output

Release gate list, missing artifacts, and stop conditions.
...
- Save the final user-facing output to `outputs/B009.md`.
- Save any execution notes, including observed reads and failures, to `traces/RB-05-O.md`.
